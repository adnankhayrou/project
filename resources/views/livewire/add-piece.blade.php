<div>
   ...
   <div class="container pt-3 w-75 bg-light rounded">
        <form wire:submit.prevent="sendPiece" id="form" class=" pb-2" enctype="multipart/form-data">
            @csrf
            ...
            <div class=" row modal-body">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input placeholder="Item name..." type="text" wire:model="name"
                ...
                <div class="col-xl-6 col-md-12 col-sm-12 mb-3 mt-1" wire:ignore>
                ...
                <div class="col-12 mb-3 items-center">
                    <div class="ms-4 btn-group" role="group" aria-label="Basic checkbox toggle button group">
                        <input class="form-check-input " type="checkbox" wire:model="active" id="flexCheckDefault">
                ...
                <div class="form my-2">
                    <textarea wire:model="description" class="form-control p-2 rounded" rows="4" placeholder="Leave a description here"></textarea>
                </div>
            ...
            <div class="modal-footer mt-3">
                <a href="en/my-pieces" class="btn btn-white border">Cancel</a>
