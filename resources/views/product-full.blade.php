        ...
        <div class="container">
            <div class="block-split__row row no-gutters">
                <div class="block-split__item block-split__item-content col-auto">
                        ...
                        <div class="product__body">
							...
							<div class="owl-carousel">
								@foreach ($piece->images as $image)
									<a class="image image--type--product" href="{{asset('/storage/'.$image)}}" target="_blank" data-width="700"data-height="700">
									<div class="image__body">
										<img class="image__tag" src="{{asset('/storage/'.$image)}}" alt="">
									</div>
									</a>
								@endforeach
							</div>
                            ...
                            <div class="product__header">
                                <h1 class="product__title">{{$piece->name}}</h1>
                                <div class="product__subtitle">
                                    <div class="product__rating  d-flex align-items-center">
                                        <div class="product__rating-stars d-flex align-items-center">
                                            @livewire('rate', ['piece' => $piece->id])
                                        </div>
                                        <div class="product__rating-label pb-2">
                                            @if ($piece->rates->count()>0)
                                                <span>( {{ $piece->rates->sum('rate') /$piece->rates->count()}} on 5 stars )</span>
                                            @else
                                                <span>( {{ $piece->rates->sum('rate')}} on 5 stars )</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="status-badge status-badge--style--success product__fit status-badge--has-icon status-badge--has-text">
                                        <div class="status-badge__body">
                                            <div class="status-badge__icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"/>
                                              </svg></div>
                                            <div class="status-badge__text">This Part for {{$piece->brand->name}} {{$piece->model->name}} {{$piece->model->year}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="product__main">
                                <div class="product__excerpt">Many philosophical debates that began in ancient times
                                    are still debated today. In one general sense, philosophy is associated with wisdom,
                                    ...
                                    <div class="product__features">
                                        ...
                                        <div class="product__features-link"><a href="#specification">See Full Specification</a>
                                        </div>
                                    </div>
                            </div>
                            <div class="product__info">
                                <div class="product__info-card">
                                    <div class="product__info-body">
                                        ...
                                        <div class="product__prices-stock">
                                            <div class="product__prices">
                                                <div class="product__price product__price--current">{{$piece->price}} MAD</div>
                                            </div>
                                            <div
												...
												@else
												<div class="status-badge__body bg-warning text-light">
                                    ...
                                    <div class="product__actions">
                                        ...
                                        <div class="product__actions-item product__actions-item--addtocart mb-3">
                                            <button  class="btn btn-primary btn-lg btn-block" @if (!$piece->active) disabled @endif>Add to cart</button></div>
										...
										{{-- <button
											...
											<div class="d-flex align-items-center">
                                                @livewire('like', ['piece' => $piece->id])<small> Add to Wishlist</small>
                                            </div>
                                    </div>
                                ...
                                <div class="product__shop-features shop-features">
                                    <ul class="shop-features__list">
                                        <li class="shop-features__item">
                                            <div class="shop-features__item-icon"><svg width="48" height="48"
                                                    viewBox="0 0 48 48">
                                                    <path
                            ...
                            <div class="product__tabs product-tabs product-tabs--layout--full">
                                <ul class="product-tabs__list">
                                    ...
                                    <li class="product-tabs__item"><a
                                            href="#product-tab-specification" id="specification">Specification</a></li>
                                ...
                                <div class="product-tabs__content">
                                    <div class="product-tabs__pane product-tabs__pane--active"
                                        ...
                                        <div class="typography">
                                            ...
                                            <p>Praesent mattis eget augue ac elementum. Maecenas vel ante ut enim mollis
                                                ...
                                                augue, at sollicitudin nisl molestie eget.</p>
                                            <p>Nunc sollicitudin, nunc id accumsan semper, libero nunc aliquet nulla,
                                                nec pretium ipsum risus ac neque. Morbi eu facilisis purus. Quisque mi
                                                tortor, cursus in nulla ut, laoreet commodo quam. Pellentesque et ornare
                                                sapien. In ac est tempus urna tincidunt finibus. Integer erat ipsum,
                                                tristique ac lobortis sit amet, dapibus sit amet purus. Nam sed lorem
                                                nisi. Vestibulum ultrices tincidunt turpis, sit amet fringilla odio
                                                scelerisque non.</p>
                                        </div>
                                    </div>
                                    <div class="product-tabs__pane" id="product-tab-specification">
                                        <div class="spec">
                                            <div class="spec__section">
                                                ...
                                                <div class="spec__row">
                                                    <div class="spec__name">Etat</div>
                                                    <div class="spec__value">{{$piece->etat->name}}</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Engine</div>
                                                    <div class="spec__value">{{$piece->motorization->name}}</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Serial Number</div>
                                                    <div class="spec__value">{{$piece->serial_number}}</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Type</div>
                                                    <div class="spec__value">{{$piece->type}}</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">reference</div>
                                                    <div class="spec__value">{{$piece->reference}}</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Speed</div>
                                                    <div class="spec__value">{{$piece->speed_index}} km/h</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Weight</div>
                                                    <div class="spec__value">{{$piece->load_index}} kg</div>
                                                </div>
                                            </div>
                                            <div class="spec__section">
                                                <h4 class="spec__section-title">Dimensions</h4>
                                                <div class="spec__row">
                                                    <div class="spec__name">Diameter</div>
                                                    <div class="spec__value">{{$piece->diameter}} mm</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Width</div>
                                                    <div class="spec__value">{{$piece->width}} mm</div>
                                                </div>
                                                <div class="spec__row">
                                                    <div class="spec__name">Height</div>
                                                    <div class="spec__value">{{$piece->height}} mm</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="review">
                                                                <div class="review__body">
                                                                    ...
                                                                    <div class="review__meta">
                                                                        <div class="review__author">Samantha Smith
                                                                        </div>
                                                                    ...
                                                                    <div class="review__content typography">Phasellus
                                                                        id mattis nulla. Mauris velit nisi, imperdiet
                                                                        vitae sodales in, maximus ut lectus. Vivamus
                                                        ...
                                                        <li class="reviews-list__item">
                                                            <div class="review">
                                                                <div class="review__body">
                                                                    ...
                                                                    <div class="review__content typography">Aenean non
                                                                        lorem nisl. Duis tempor sollicitudin orci, eget
                                                                        tincidunt ex semper sit amet. Nullam neque
                                                                        justo, sodales congue feugiat ac, facilisis a
                                                                        augue. Donec tempor sapien et fringilla
                                                                        facilisis. Nam maximus consectetur diam. Nulla
                                                                        ut ex mollis, volutpat tellus vitae, accumsan
                                                                        ligula.</div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="reviews-list__item">
                                                            <div class="review">
                                                                <div class="review__body">
                                                                    ...
                                                                    <div class="review__content typography">Duis ac
                                                                        lectus scelerisque quam blandit egestas.
                                                    ...
                                                    <div class="col-xxl-8 col-xl-10 col-lg-9 col-12">
                                                        <div class="form-row">
                                                            <div class="form-group col-md-4"><label
                                                                    for="review-stars">Review Stars</label> <select
                                                                    id="review-stars" class="form-control">
                                                            ...
                                                            <div class="form-group col-md-4"><label
                                                                    for="review-email">Email Address</label> <input
                                                                    type="text" class="form-control"
                                                        ...
                                                        <div class="form-group mb-0 mt-4"><button type="submit"
                                                                class="btn btn-primary">Post Your Review</button></div>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="product-tabs__pane" id="product-tab-analogs">
                                        <table class="analogs-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="analogs-table__column analogs-table__column--name"><a
                                                            href="#" class="analogs-table__product-name">Sunset
                                                            Brake Kit</a><br>
                                                    ...
                                                    <td class="analogs-table__column analogs-table__column--vendor"
                                                        data-title="Vendor">Sunset<div class="analogs-table__country">
                                                            (Germany)</div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="analogs-table__column analogs-table__column--name"><a
                                                            href="#" class="analogs-table__product-name">Specter
                                                            Brake Kit</a><br>
                                                ...
                                                <tr>
                                                    <td class="analogs-table__column analogs-table__column--name"><a
                                                            href="#" class="analogs-table__product-name">Brake
                                                            Kit</a><br>
                    ...
                    {{-- related pieces --}}
					 @livewire('related-pieces', ['brand_id' => $piece->brand_id])
					{{-- end --}}
                </div>
            </div>
        </div>
