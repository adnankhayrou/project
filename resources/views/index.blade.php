        ...
        <div class="modal-content">
            ...
            <div class="vehicle-picker-modal__panel" data-panel="form">
                ...
                <div class="vehicle-form vehicle-form--layout--modal">
                    ...
                    <div class="vehicle-form__divider">
                        Or
                    </div>
                    <div class="vehicle-form__item">
                        <input type="text" class="form-control" placeholder="Enter VIN number"
                ...
                <li class="block-features__item">
                    ...
                    <div class="block-features__item-info">
                        ...
                        <div class="block-features__item-subtitle">
                            {{ __('pages/client/home.for_orders_from') }} 50 MAD.
                        </div>
                    </div>
                </li>
                <li class="block-features__item">
                    ...
                    <div class="block-features__item-info">
                        ...
                        <div class="block-features__item-subtitle">
                            {{ __('pages/client/home.call_us_anytime') }}
                        </div>
                    </div>
                </li>
                <li class="block-features__item">
                    <div class="block-features__item-icon">
                        <svg width="48" height="48" viewBox="0 0 48 48">
                            ...
                            <path d="M40.3,33.5c-1.2,0-2.1,0.9-2.1,2.1c0,0.9,0.5,1.6,1.3,1.9v1.1c0,0.4,0.4,0.8,0.8,0.8s0.8-0.4,0.8-0.8v-1.1	c0.8-0.3,1.3-1.1,1.3-1.9C42.4,34.4,41.5,33.5,40.3,33.5z M40.3,35.1c0.3,0,0.5,0.2,0.5,0.5s-0.2,0.5-0.5,0.5s-0.5-0.2-0.5-0.5	S40.1,35.1,40.3,35.1z" />
                        </svg>
                    </div>
                    <div class="block-features__item-info">
                        <div class="block-features__item-title">{{ __('pages/client/home.safety_100') }}</div>
                        <div class="block-features__item-subtitle">
                            {{ __('pages/client/home.only_secure_payments') }}
                        </div>
                    </div>
                </li>
                <li class="block-features__item">
                    ...
                    <div class="block-features__item-info">
                        ...
                        <div class="block-features__item-subtitle">
                            {{ __('pages/client/home.discounts_up_to_90') }}
                        </div>
                    </div>
                </li>
            </ul>
                ...
                <div class="block-zone__card category-card category-card--layout--overlay">
                    <div class="category-card__body">
                        <div class="category-card__overlay-image">
                            <img srcset="{{ asset('images/categories/category-overlay-1-mobile.jpg') }} 530w,
                            {{ asset('images/categories/category-overlay-1.jpg') }} 305w" 
                            src="{{ asset('images/categories/category-overlay-1.jpg') }}" 
                        ...
                        <div class="category-card__content">
                            <div class="category-card__info">
                                ...
                                <div class="category-card__actions">
                                    <a href="shop-grid-4-columns-sidebar.html" class="btn btn-primary btn-sm">{{ __('pages/client/home.shop_all') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="block-zone__widget-header">
                        <div class="block-zone__tabs">
                            <button class="block-zone__tabs-button block-zone__tabs-button--active" type="button">
                                {{__('pages/client/home.featured')}}
                            </button>
                            <button class="block-zone__tabs-button" type="button">
                                {{__('pages/client/home.bestsellers')}}
                            </button>
                            <button class="block-zone__tabs-button" type="button">
                                {{__('pages/client/home.popular')}}
                            </button>
                        </div>
                    ...
                    <div class="block-zone__widget-body">
                        <div class="block-zone__carousel">
                            ...
                            <div class="owl-carousel">
                                @php
                                    // $pieces = Illuminate\Support\Facades\DB::table('pieces')->join('categories', 'categories.id', '=', 'pieces.category_id')->where('categories.name', '=', 'Wheels & Tires')->select('pieces.*', 'categories.*')->get();
                                    $parentCategory = App\Models\Category::where('name', 'Wheels & Tires')->first();
                                    $pieces = App\Models\Pieces::whereHas('category', function ($query) use ($parentCategory) {
                                        $query->where('name', 'Wheels & Tires')->orWhere('parent_id',$parentCategory->id);
                                    })->get();
                                @endphp
                                @foreach ($pieces as $piece)
                                    <div class="block-zone__carousel-item">
                                        <div class="product-card" style="overflow: hidden !important">
                                                @livewire('like', ['piece' => $piece->id])
                                            <div class="product-card__image">
                                                <div class="image image--type--product">
                                                    <a href="{{ route('piece.show-piece', $piece->id)}}" class="image__body"><img
                                                            class="image__tag"
                                            ...
                                            <div class="product-card__info">
                                                ...
                                                <div class="product-card__rating">
                                                    <div class="rating product-card__rating-stars">
                                                        @if ($piece->rates->count() > 0)
                                                            @php
                                                                $averageRating = round($piece->rates->sum('rate') / $piece->rates->count());
                                                            @endphp
        ...
        <div class="container">
            <div class="block-zone__body">
                <div class="block-zone__card category-card category-card--layout--overlay">
                    <div class="category-card__body">
                        <div class="category-card__overlay-image">
                            <img srcset=" {{ asset('images/categories/category-overlay-2-mobile.jpg') }} 530w, {{ asset('images/categories/category-overlay-2.jpg') }}        305w"
                                src="{{ asset('images/categories/category-overlay-2.') }}jpg"
                                sizes="(max-width: 575px) 530px, 305px" alt="" />
                        </div>
                        <div class="category-card__overlay-image category-card__overlay-image--blur">
                            <img srcset=" {{ asset('images/categories/category-overlay-2-mobile.jpg') }} 530w, {{ asset('images/categories/category-overlay-2.jpg') }}        305w"
                ...
                <div class="block-zone__widget">
                    ...
                    <div class="block-zone__widget-body">
                        <div class="block-zone__carousel">
                            ...
                            <div class="owl-carousel">
                                @php
                                    $parentCategory = App\Models\Category::where('name', 'Interior Parts')->first();
                                    $pieces = App\Models\Pieces::whereHas('category', function ($query) use ($parentCategory) {
                                        $query->where('name', 'Interior Parts')->orWhere('parent_id',$parentCategory->id);
                                    })->get();
                                @endphp
                                @foreach ($pieces as $piece)
                                    <div class="block-zone__carousel-item">
        ...
        <div class="container">
            <div class="block-zone__body">
                <div class="block-zone__card category-card category-card--layout--overlay">
                    <div class="category-card__body">
                        <div class="category-card__overlay-image">
                            <img srcset="{{ asset('images/categories/category-overlay-3-mobile.jpg') }} 530w,
                            {{ asset('images/categories/category-overlay-3.jpg') }} 305w"
                                src="{{ asset('images/categories/category-overlay-3.jpg') }}"
                                sizes="(max-width: 575px) 530px, 305px" alt="" />
                        </div>
                        <div class="category-card__overlay-image category-card__overlay-image--blur">
                            <img srcset="
                            {{ asset('images/categories/category-overlay-3-mobile.jpg') }} 530w,
                            {{ asset('images/categories/category-overlay-3.jpg') }} 305w"
                                src="{{ asset('images/categories/category-overlay-3.jpg') }}"
                                sizes="(max-width: 575px) 530px, 305px" alt="" />
                        </div>
                        <div class="category-card__content">
                            <div class="category-card__info">
                                ...
                                <ul class="category-card__children">
                                    ...
                                    <li>
                                        <a href="category-4-columns-sidebar.html">Engine Gaskets</a>
                                    </li>
                                    <li>
                                        <a href="category-4-columns-sidebar.html">Oil Filters</a>
                                    </li>
                                    <li>
                                        <a href="category-4-columns-sidebar.html">Engine Mounts</a>
                                    </li>
                                    <li>
                                        <a href="category-4-columns-sidebar.html">Accessories</a>
                                    </li>
                ...
                <div class="block-zone__widget">
                    ...
                    <div class="block-zone__widget-body">
                        <div class="block-zone__carousel">
                            ...
                            <div class="owl-carousel">
                                @php
                                    $parentCategory = App\Models\Category::where('name', 'Engine & Drivetrain')->first();
                                    $pieces = App\Models\Pieces::whereHas('category', function ($query) use ($parentCategory) {
                                        $query->where('name', 'Engine & Drivetrain')->orWhere('parent_id',$parentCategory->id);
                                    })->get();
                                @endphp
                                @foreach ($pieces as $piece)
                                    <div class="block-zone__carousel-item">
    ...
    <div class="block-banners block">
        <div class="container">
            <div class="block-banners__list">
                <a href="{{route('category.filterCategory', 8)}}" class="block-banners__item block-banners__item--style--one"><span
                        class="block-banners__item-image"><img src="{{ asset('images/banners/banner1.jpg') }}"
                            alt="" /></span><span
                        class="block-banners__item-image block-banners__item-image--blur"><img
                            src="{{ asset('images/banners/banner1.jpg') }}" alt="" /></span><span
                        class="block-banners__item-title">Motor Oils</span>
                    <span class="block-banners__item-details">Synthetic motor oil with free shipping<br />Friction
                        free
                        life guaranteed </span><span class="block-banners__item-button btn btn-primary btn-sm">Shop
                        Now
                    </span></a>
                    
                    <a href="{{route('category.filterCategory', 17)}}" class="block-banners__item block-banners__item--style--two"><span
                        class="block-banners__item-image"><img src="{{ asset('images/banners/banner2.jpg') }}"
                            alt="" /></span><span
                        class="block-banners__item-image block-banners__item-image--blur"><img
                            src="{{ asset('images/banners/banner2.jpg') }}" alt="" /></span><span
                        class="block-banners__item-title">Interior Parts</span>
                    <span class="block-banners__item-details">Luxurious interior part for real aesthetes<br />Leather,
                        fabric, ivory and more. </span><span
    ...
    <div class="block block-products-carousel" data-layout="horizontal">
        <div class="container">
                ...
                <div class="section-header__body">
                    ...
                    <ul class="section-header__links">
                        <li class="section-header__links-item">
                            <a href="#" class="section-header__links-link">{{ __('pages/client/home.wheel_covers') }}</a>
                        </li>
                        <li class="section-header__links-item">
                            <a href="#" class="section-header__links-link">{{ __('pages/client/home.timing_belts') }}</a>
                        </li>
                        <li class="section-header__links-item">
                            <a href="#" class="section-header__links-link">{{ __('pages/client/home.oil_pans') }}</a>
                        </li>
                        <li class="section-header__links-item">
                            <a href="#" class="section-header__links-link">{{ __('pages/client/home.show_all') }}</a>
                        </li>
                    </ul>
            ...
            <div class="block-products-carousel__carousel">
                ...
                <div class="owl-carousel">
                    @php
                        $pieces = App\Models\Pieces::orderBy('created_at')->take(6)->get()
                    @endphp
                    @foreach ($pieces as $piece) 
        ...
        <div class="container">
            <ul class="block-brands__list">
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-1.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.aim_parts') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-2.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.wind_engine') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-3.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.turbo_electric') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-4.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.start_one') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-5.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.brandix') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-6.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.abs_brand') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-7.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.great_circle') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-8.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.just_romb') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-9.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.fast_wheels') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-10.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.stroyka_x') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-11.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.mission_51') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-12.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.fuel_corp') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-13.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.red_gate') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-14.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.blocks') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-15.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.black_box') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
                <li class="block-brands__item">
                    <a href="#" class="block-brands__item-link"><img src="{{ asset('images/brands/brand-16.png') }}"
                            alt="" />
                        <span class="block-brands__item-name">{{ __('pages/client/home.square_garage') }}</span></a>
                </li>
                <li class="block-brands__divider" role="presentation"></li>
            </ul>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-4">
                    ...
                    @php
                        $pieces = Illuminate\Support\Facades\DB::table('rates as r')->select('r.id', 'r.rate', 'p.id as piece_id', 'p.name', 'l.id as like_id','p.price','p.new_price','p.images')->join('pieces as p', 'p.id', '=', 'r.piece_id')->join('likes as l', 'l.piece_id', '=', 'p.id')->groupBy('r.id', 'r.rate', 'p.id', 'p.name', 'l.id','p.price','p.new_price','p.images')->orderBy('r.rate')->orderBy(DB::raw('count(r.id)'))->limit(3)->get();
                    @endphp
                        ...
                        @foreach ($pieces as $piece)
                            <div class="block-products-columns__list-item">
                                <div class="product-card ">
                                    <div class="product-card__image">
                                        @php
                                            $imagesString = stripslashes($piece->images);
                                            $imagesArray  = json_decode($imagesString);
                                        @endphp
                                        <div class="image image--type--product">
                                            <a href="{{ route('piece.show-piece',$piece->piece_id) }}" class="image__body">
                                                <img class="image__tag" src="{{asset('/storage/'.$imagesArray[0])}}" alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-card__info">
                                        <div class="product-card__name">
                                            <div>
                                                ...
                                                <a href="{{ route('piece.show-piece',$piece->piece_id) }}">{{ $piece->name }}</a>
                                            </div>
                                        </div>
                                        <div class="product-card__rating">
                                            <div class="rating product-card__rating-stars">
                                                <div class="rating__body">
                                                    @php
                                                        $rtPiece=App\Models\Pieces::find($piece->piece_id);
                                                    @endphp
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        @if ($i <= round($rtPiece->rates->avg('rate')))
                                                            <div class="rating__star rating__star--active"></div>
                                                        @else
                                                            <div class="rating__star"></div>
                                                        @endif
                                            ...
                                            <div class="product-card__rating-label">
                                                rate : {{ round($rtPiece->rates->avg('rate'),1)}}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-card__footer">
                        ...
                        <div class="block-products-columns__list-item">
                            <div class="product-card">
                                ...
                                <div class="product-card__image">
                                    <div class="image image--type--product">
                                        <a href="{{ route('piece.show-piece',$piece->id) }}" class="image__body"><img class="image__tag"
                                                src="{{ asset('images/products/product-4-245x245.jpg') }}" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card__info">
                                    <div class="product-card__name">
                                        <div>
                                            ...
                                            <a href="{{ route('piece.show-piece',$piece->id) }}">Glossy Gray 19" Aluminium Wheel AR-19</a>
                                        </div>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="rating product-card__rating-stars">
                        ...
                        <div class="block-products-columns__list-item">
                            <div class="product-card">
                                ...
                                <div class="product-card__image">
                                    <div class="image image--type--product">
                                        <a href="{{ route('piece.show-piece',$piece->id) }}" class="image__body"><img class="image__tag"
                                                src="{{ asset('images/products/product-5-245x245.jpg') }}" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card__info">
                                    <div class="product-card__name">
                                        <div>
                                            <a href="{{ route('piece.show-piece',$piece->id) }}">Twin Exhaust Pipe From Brandix Z54</a>
                                        </div>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="rating product-card__rating-stars">
                        ...
                        <div class="block-products-columns__list-item">
                            <div class="product-card">
                                ...
                                <div class="product-card__image">
                                    <div class="image image--type--product">
                                        <a href="{{ route('piece.show-piece',$piece->id) }}" class="image__body"><img class="image__tag"
                                                src="{{ asset('images/products/product-6-245x245.jpg') }}" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card__info">
                                    <div class="product-card__name">
                                        <div>
                                            <a href="{{ route('piece.show-piece',$piece->id) }}">Motor Oil Level 5</a>
                                        </div>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="rating product-card__rating-stars">
                        ...
                        <div class="block-products-columns__list-item">
                            <div class="product-card">
                                ...
                                <div class="product-card__image">
                                    <div class="image image--type--product">
                                        <a href="{{ route('piece.show-piece',$piece->id) }}" class="image__body"><img class="image__tag"
                                                src="{{ asset('images/products/product-7-245x245.jpg') }}" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card__info">
                                    <div class="product-card__name">
                                        <div>
                                            <a href="{{ route('piece.show-piece',$piece->id) }}">Brandix Engine Block Z4</a>
                                        </div>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="rating product-card__rating-stars">
                        ...
                        <div class="block-products-columns__list-item">
                            <div class="product-card">
                                ...
                                <div class="product-card__image">
                                    <div class="image image--type--product">
                                        <a href="{{ route('piece.show-piece',$piece->id) }}" class="image__body"><img class="image__tag"
                                                src="{{ asset('images/products/product-8-245x245.jpg') }}" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card__info">
                                    <div class="product-card__name">
                                        <div>
                                            <a href="{{ route('piece.show-piece',$piece->id) }}">Brandix Clutch Discs Z175</a>
                                        </div>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="rating product-card__rating-stars">
                        ...
                        <div class="block-products-columns__list-item">
                            <div class="product-card">
                                ...
                                <div class="product-card__image">
                                    <div class="image image--type--product">
                                        <a href="{{ route('piece.show-piece',$piece->id) }}" class="image__body"><img class="image__tag"
                                                src="{{ asset('images/products/product-9-245x245.jpg') }}" alt="" /></a>
                                    </div>
                                </div>
                                <div class="product-card__info">
                                    <div class="product-card__name">
                                        <div>
                                            <a href="{{ route('piece.show-piece',$piece->id) }}">Brandix Manual Five Speed Gearbox</a>
                                        </div>
                                    </div>
                                    <div class="product-card__rating">
                                        <div class="rating product-card__rating-stars">
