                        ...
                        <div class="col-12 col-lg-3 d-flex">
                            <div class="account-nav flex-grow-1">
                                ...
                                <ul class="account-nav__list">
                                    <li class="account-nav__item account-nav__item--active"><a href="{{route('account-dashboard')}}">{{__('pages/client/dashboard.dashboard')}}</a></li>
                                    <li class="account-nav__item"><a href="{{route('my-pieces')}}">Pieces</a></li>
                                    {{-- <li class="account-nav__item"><a href="account-garage.html">{{__('pages/client/dashboard.garage')}}</a></li> --}}
                                    <li class="account-nav__item"><a href="{{ route('profile.edit')}}">{{__('pages/client/dashboard.edit_profile')}}</a></li>
                                    <li class="account-nav__item"><a href="account-orders.html">{{__('pages/client/dashboard.order_history')}}</a></li>
                                    <li class="account-nav__item"><a href="account-order-details.html">{{__('pages/client/dashboard.order_details')}}</a></li>
                                    <li class="account-nav__item"><a href="account-addresses.html">{{__('pages/client/dashboard.addresses')}}</a> </li>
                                    <li class="account-nav__item"><a href="account-edit-address.html">{{__('pages/client/dashboard.edit_address')}}</a></li>
                                    <li class="account-nav__item"><a href="account-password.html">{{__('pages/client/dashboard.password')}}</a></li>
                                    <li class="account-nav__divider" role="presentation"></li>
                                    <li class="account-nav__item"><a href="account-login.html">{{__('pages/client/dashboard.logout')}}</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="dashboard">
                                <div class="dashboard__profile card profile-card">
                                    <div class="card-body profile-card__body">
                                        ...
                                        <i class="bi bi-person-fill fs-2 my-3"></i>
                                        @endif
                                        <div class="profile-card__name mb-2">{{auth()->user()->first_name}}{{auth()->user()->last_name}}</div>
                                        <div class="profile-card__email">{{auth()->user()->email}}</div>
                                        <div class="profile-card__edit"><a href="{{ route('profile.edit')}}"
                                                class="btn btn-secondary btn-sm">{{__('pages/client/dashboard.edit_profile')}}</a></div>
                                    </div>
                                </div>
                                <div class="dashboard__address card address-card address-card--featured">
                                    <div class="address-card__badge tag-badge tag-badge--theme">{{__('pages/client/dashboard.default')}}</div>
                                    <div class="address-card__body">
                                        <div class="address-card__name">{{__('pages/client/dashboard.address_name')}}</div>
                                        <div class="address-card__row">{{__('pages/client/dashboard.address_details')}}</div>
                                        <div class="address-card__row">
                                            <div class="address-card__row-title">{{__('pages/client/dashboard.phone')}}</div>
                                            <div class="address-card__row-content">{{__('pages/client/dashboard.phone_number')}}</div>
                                        </div>
                                        <div class="address-card__row">
                                            <div class="address-card__row-title">{{__('pages/client/dashboard.email')}}</div>
                                            <div class="address-card__row-content">{{__('pages/client/dashboard.email_address')}}</div>
                                        </div>
                                        <div class="address-card__footer"><a href="#">{{__('pages/client/dashboard.edit_address')}}</a></div>
                                    </div>
                                </div>
                                <div class="dashboard__orders card">
                                    <div class="card-header">
                                        <h5>{{__('pages/client/dashboard.recent_orders')}}</h5>
                                    </div>
                                    ...
                                    <div class="card-table">
                                        <div class="table-responsive-sm">
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th>{{__('pages/client/dashboard.order')}}</th>
                                                        <th>{{__('pages/client/dashboard.date')}}</th>
                                                        <th>{{__('pages/client/dashboard.status')}}</th>
                                                        <th>{{__('pages/client/dashboard.total')}}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>02 April, 2019</td>
                                                        <td>{{__('pages/client/dashboard.pending')}}</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>15 March, 2019</td>
                                                        <td>{{__('pages/client/dashboard.shipped')}}</td>
                    ...
                    <div class="mobile-menu__indicators"><a class="mobile-menu__indicator"
                            ...
                            class="mobile-menu__indicator" href="account-dashboard.html"><span
                                class="mobile-menu__indicator-icon"><svg width="20" height="20">
                                    <path
                                        d="M20,20h-2c0-4.4-3.6-8-8-8s-8,3.6-8,8H0c0-4.2,2.6-7.8,6.3-9.3C4.9,9.6,4,7.9,4,6c0-3.3,2.7-6,6-6s6,2.7,6,6 c0,1.9-0.9,3.6-2.3,4.7C17.4,12.2,20,15.8,20,20z M14,6c0-2.2-1.8-4-4-4S6,3.8,6,6s1.8,4,4,4S14,8.2,14,6z" />
                            ...
                            class="mobile-menu__indicator" href="cart.html"><span
                                ...
                                class="mobile-menu__indicator-title">Cart</span> </a>
                                {{-- <a
                            class="mobile-menu__indicator" href="account-garage.html"><span
                                ...
                                </svg> </span><span class="mobile-menu__indicator-title">Garage</span></a> --}}
                            </div>
                    <div class="mobile-menu__divider"></div>
                    <ul class="mobile-menu__links">
                                ...
                                <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                    ...
                                    <div class="mobile-menu__panel-body">
                                        <ul class="mobile-menu__links">
                                            ...
                                            <li data-mobile-menu-item><a href="{{ route('profile.edit')}}" class=""
