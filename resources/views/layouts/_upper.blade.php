<main id="app">
                ...
                <div class="container">
                    <div class="mobile-header__body"><button class="mobile-header__menu-button" type="button"><svg
                                ...
                                <path
                                    ...
                                    <img src=" {{ asset('/assets/images/logo.png') }}" style="aspect-ratio: 1/1;width: 120px; object-fit: cover; object-position:center;">
	...
	C15.5,10.2,14,11.3,14,12z" />
                                    </svg> <span class="mobile-search__vehicle-picker-label">{{__('layouts/upper.vehicle')}}</span></button>
